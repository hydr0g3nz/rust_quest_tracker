...
use crate::{config::config_loader::{get_adventure_secret_env, get_guild_commander_secret_env}, domain::repositories::{adventurers::AdventurerRepository, guild_commanders::GuildCommanderRepository}, infra::{argon2_hashing, jwt_authentication::{self, authentication_model::LoginModel, jwt_model::{Claims, Passport, Roles}}}};
    ...
    T2: GuildCommanderRepository + Send + Sync,
{
    ...
    pub async fn adventurers_login(&self, login_model: LoginModel) -> Result<Passport> {
        let secret_env = get_adventure_secret_env()?;
    ...
    pub async fn guild_commanders_login(&self, login_model: LoginModel) -> Result<Passport> {
        ...
        let secret_env = get_guild_commander_secret_env()?;
